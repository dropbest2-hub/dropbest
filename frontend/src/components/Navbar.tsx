...
export default function Navbar() {
    ...
    return (
        <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'glass py-2' : 'bg-transparent py-4 sm:py-6'}`}>
                    ...
                    <div className="flex items-center">
                        <Link href="/" className="flex items-center gap-2 group hover:scale-105 transition-transform duration-300">
                             <img 
                                src="/logo.png" 
                                alt="DropBest!" 
                                className="h-24 sm:h-48 w-auto object-contain drop-shadow-md"
                            />
                        </Link>
                    </div>
