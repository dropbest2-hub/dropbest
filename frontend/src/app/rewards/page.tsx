...
import { Award, Ticket, ArrowRight, CheckCircle2, AlertCircle, ShoppingBag, Sparkles, Zap, Gift, Copy, ChevronRight } from 'lucide-react';
...
export default function Rewards() {
 ...
 Your style has value. Convert your earned badges into real-world shopping power.
 </p>
 </div>
 ...
 <p className="text-violet-200 text-sm font-bold uppercase tracking-widest mb-2">Available Balance</p>
 <div className="flex items-center gap-3 mb-4">
 <Award className="text-yellow-400" size={40} />
 <span className="text-6xl font-black tracking-tighter">{user.badge_count}</span>
 </div>
 
 <div className="w-full space-y-2">
 <div className="flex justify-between text-xs font-bold text-violet-200">
 ...
 <ShoppingBag size={20} /> Browse Rewards
 </div>
 </button>
 <button 
 ...
 <div className="absolute top-6 right-6 text-gray-200 group-hover:text-green-500/20 transition-colors">
 <Zap size={80} />
 </div>
 ...
 <p className="text-gray-500 font-medium mb-8">Perfect for a quick discount on your next tech accessory.</p>
 ...
 >
 {converting ? 'Processing...' : user.badge_count < 110 ? 'Not Enough Badges' : 'Redeem Now'}
 ...
 <p className="text-violet-100 font-medium mb-8">Maximum value conversion for dedicated brand enthusiasts.</p>
 ...
 >
 {converting ? 'Processing...' : user.badge_count < 220 ? 'Not Enough Badges' : 'Redeem Now'}
 <ChevronRight size={20} />
 </button>
 </div>

 {/* Coming Soon Tier */}
 <div className="relative bg-gray-50 rounded-[2.5rem] p-8 border border-dashed border-gray-200 flex flex-col items-center justify-center text-center opacity-70">
 <div className="w-16 h-16 bg-gray-100 text-gray-400 rounded-full mb-4 flex items-center justify-center">
 <Sparkles size={32} />
 </div>
 <h3 className="text-xl font-bold text-gray-400 px-8">Mystery Rewards Coming Soon</h3>
 </div>
 </motion.div>
 ) : (
 <motion.div 
 ...
 <p className="text-gray-500 mt-2 max-w-sm mx-auto">Convert your badges in the shop to see your exclusive coupon codes here.</p>
 ...
 Deducted {reward.badges_used} Badges • {new Date(reward.created_at).toLocaleDateString()}
 </p>
 </div>
